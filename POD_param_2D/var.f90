    ...
    module var_POD
        ...
        integer, parameter :: n_snapshot=800   ! total number of snapshot = 2*n_snapshot
        integer, parameter :: Nmodes=100        ! number of POD modes
        integer, parameter :: nnode = 37617, nelem = 74750 ! Cylinder nnode=55634, nelem=110581
